...
public final class Guard {
    ...
    public static <T> T notNull(T value) {
        if (value == null) throw new NullPointerException(MUST_NOT_BE_NULL);
        return value;
    }
    ...
    public static <T> T notNull(T value, Supplier<String> message) {
        if (value == null) throw new NullPointerException(GuardInternal.lazy(message, MUST_NOT_BE_NULL));
        return value;
    }
    ...
    public static void isTrue(boolean condition) {
        if (!condition) throw new IllegalArgumentException(REQUIREMENT_MUST_BE_TRUE);
    }
    ...
    public static void isTrue(boolean condition, Supplier<String> message) {
        if (!condition) throw new IllegalArgumentException(GuardInternal.lazy(message, REQUIREMENT_MUST_BE_TRUE));
    }
    ...
    public static String notBlank(String text) {
        return strings().notBlank(text, () -> TEXT_MUST_NOT_BE_BLANK);
    }
    ...
    public static String notBlank(String text, Supplier<String> message) {
        return strings().notBlank(text, message);
    }
    ...
    public static String hasText(String text) {
        return strings().hasText(text, () -> TEXT_MUST_NOT_BE_BLANK);
    }
    ...
    public static String hasText(String text, Supplier<String> message) {
        return strings().hasText(text, message);
    }
    ...
    public static String lengthBetween(String text, int minLength, int maxLength) {
        return strings().lengthBetween(text, minLength, maxLength, () -> "텍스트 길이가 " + minLength + "에서 " + maxLength + " 사이여야 합니다.");
    }
    ...
    public static String lengthBetween(String text, int minLength, int maxLength, Supplier<String> message) {
        return strings().lengthBetween(text, minLength, maxLength, message);
    }
    ...
    public static String matches(String text, String regex) {
        return strings().matches(text, regex, () -> "텍스트가 정규식 " + regex + "와 일치해야 합니다.");
    }
    ...
    public static String matches(String text, String regex, Supplier<String> message) {
        return strings().matches(text, regex, message);
    }
    ...
    public static <T extends Number & Comparable<T>> T inRange(T value, T min, T max) {
        return numbers().inRange(value, min, max, () -> "숫자가 " + min + "에서 " + max + " 사이여야 합니다.");
    }
    ...
    public static <T extends Number & Comparable<T>> T inRange(T value, T min, T max, Supplier<String> message) {
        return numbers().inRange(value, min, max, message);
    }
    ...
    public static <T extends Number & Comparable<T>> T positive(T value) {
        return numbers().positive(value, () -> "숫자는 양수여야 합니다.");
    }
    ...
    public static <T extends Number & Comparable<T>> T positive(T value, Supplier<String> message) {
        return numbers().positive(value, message);
    }
    ...
    public static <T extends Number & Comparable<T>> T equals(T value, T expected) {
        return numbers().equals(value, expected, () -> "숫자 " + value + "는 " + expected + "와 같아야 합니다.");
    }
    ...
    public static <T extends Number & Comparable<T>> T equals(T value, T expected, Supplier<String> message) {
        return numbers().equals(value, expected, message);
    }
    ...
    public static <T extends Number & Comparable<T>> T notEquals(T value, T unexpected) {
        return numbers().notEquals(value, unexpected, () -> "숫자 " + value + "는 " + unexpected + "와 달라야 합니다.");
    }
    ...
    public static <T extends Number & Comparable<T>> T notEquals(T value, T unexpected, Supplier<String> message) {
        return numbers().notEquals(value, unexpected, message);
    }
    ...
    public static <T extends java.util.Collection<?>> T notEmpty(T collection) {
        return collections().notEmpty(collection, () -> "컬렉션은 비어있을 수 없습니다.");
    }
     ...
     * @throws IllegalArgumentException 컬렉션이 null이거나 비어있는 경우
     */
    public static <T extends java.util.Collection<?>> T notEmpty(T collection, Supplier<String> message) {
        return collections().notEmpty(collection, message);
    }
     ...
     */
    public static <T extends java.util.Collection<?>> T noNullElements(T collection) {
        return collections().noNullElements(collection, () -> "컬렉션은 null 요소를 포함할 수 없습니다.");
    }
     ...
     * @throws IllegalArgumentException 컬렉션이 null 요소를 포함하는 경우
     */
    public static <T extends java.util.Collection<?>> T noNullElements(T collection, Supplier<String> message) {
        return collections().noNullElements(collection, message);
    }
