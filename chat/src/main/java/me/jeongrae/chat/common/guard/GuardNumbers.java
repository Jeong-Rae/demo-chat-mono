...
public final class GuardNumbers {
    ...
    public static <T extends Number & Comparable<T>> T inRange(T value, T min, T max, Supplier<String> message) {
        return inRange(value, min, max, GuardInternal.lazy(message, NUMBER_MUST_BE_IN_RANGE));
    }
    ...
    public static <T extends Number & Comparable<T>> T inRange(T value, T min, T max, String message) {
        ...
        GuardInternal.notNull(min, message);
        GuardInternal.notNull(max, message);
    ...
    public static <T extends Number & Comparable<T>> T positive(T value, Supplier<String> message) {
        return positive(value, GuardInternal.lazy(message, NUMBER_MUST_BE_POSITIVE));
    }
    ...
    public static <T extends Number & Comparable<T>> T min(T value, T min, Supplier<String> message) {
        return min(value, min, GuardInternal.lazy(message, NUMBER_MUST_BE_GREATER_THAN_OR_EQUAL_TO_MIN));
    }
    ...
    public static <T extends Number & Comparable<T>> T max(T value, T max, Supplier<String> message) {
        return max(value, max, GuardInternal.lazy(message, NUMBER_MUST_BE_LESS_THAN_OR_EQUAL_TO_MAX));
    }
